...
export const getMoreDataOfPlantByScientificName = async (
  req: Request,
  res: Response
) => {
  const scientificName = req.params.scientificName;
  const plantNetApiUrl = `https://api.plantnet.org/v1/projects/k-world-flora/species?pageSize=5&page=0&lang=fr&search=${
...
// get random answers
export const getRandomAnswer = async (req: Request, res: Response) => {
